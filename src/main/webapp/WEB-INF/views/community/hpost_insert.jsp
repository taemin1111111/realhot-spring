...
<%
    ...
    // Controller에서 전달된 카테고리 정보
    Integer categoryId = (Integer) request.getAttribute("categoryId");
    String categoryIcon = (String) request.getAttribute("categoryIcon");
    String categoryName = (String) request.getAttribute("categoryName");
    
    // 기본값 설정
    if (categoryId == null) categoryId = 1;
    if (categoryIcon == null) categoryIcon = "❤️";
    if (categoryName == null) categoryName = "헌팅썰";
%>

<div class="write-container">
    <div class="write-container">
        <div class="write-header">
            <h2 class="write-title"><%= categoryIcon %> <%= categoryName %> 글쓰기</h2>
            <button type="button" class="back-btn" onclick="window.goBackToList()">← 목록으로</button>
        </div>
        
        <form action="<%=root%>/api/community/post/insert?action=insert" method="post" enctype="multipart/form-data" class="write-form" id="writeForm">
            ...
            <div class="form-actions">
                ...
                <button type="button" class="cancel-btn" onclick="window.goBackToList()">취소</button>
            </div>
        </form>
    </div>
</div>
